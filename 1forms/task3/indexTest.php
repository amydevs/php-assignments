...
<html lang="en">
	...
	<body>
        <div id="app" onkeydown="snakeChecker()">
			<iframe onload="iframeLoaded()" src="http://www.menet.umn.edu/~dockt036/snake.html" width="500px" height="400px"></iframe>
...
<script>
	...
	function iframeLoaded() {
		setTimeout(function(){ console.log(document.querySelector('iframe').contentWindow['mySnakeBoard']) }, 3000);
